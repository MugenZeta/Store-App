...
using backend_api.Test.Core.DataGen.DataFactories;
...
public abstract class DataServiceSqlServerBaseIntegrationTests<TEntity, TId> :
    DataServiceBaseIntegrationTests<TEntity, TId>,
    IServiceTest<IEntityDataService<TEntity>>
    where TEntity : class, new()
{
    protected DataServiceSqlServerBaseIntegrationTests(IEntityDataService<TEntity> dataService,
        Expression<Func<TEntity, TId>> idExpression, EntityDataFactory<TEntity> entityDataFactory = null)
